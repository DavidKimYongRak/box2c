...
namespace Box2DSharpRenderTest
{
	...
	public class BipedDef
	{
		...
		float _scale;
		public BipedDef(float scale = 3.0f)
		{
		...
		void DefaultVertices()
		{
			{	// feet
				Fixtures[(int)EBipedFixtureIndex.LFoot].Shape =
					...
					new PolygonShape(
						_scale * new Vec2(.033f, .143f),
						_scale * new Vec2(.023f, .033f),
						_scale * new Vec2(.267f, .035f),
						_scale * new Vec2(.265f, .065f),
						_scale * new Vec2(.117f, .143f));
			}
			{	// calves
				Fixtures[(int)EBipedFixtureIndex.LCalf].Shape =
					Fixtures[(int)EBipedFixtureIndex.RCalf].Shape =
					new PolygonShape(
						_scale * new Vec2(.089f, .016f),
						_scale * new Vec2(.178f, .016f),
						_scale * new Vec2(.205f, .417f),
						_scale * new Vec2(.095f, .417f));
			}
			{	// thighs
				Fixtures[(int)EBipedFixtureIndex.LThigh].Shape =
					Fixtures[(int)EBipedFixtureIndex.RThigh].Shape =
					new PolygonShape(
						_scale * new Vec2(.137f, .032f),
						_scale * new Vec2(.243f, .032f),
						_scale * new Vec2(.318f, .343f),
						_scale * new Vec2(.142f, .343f));
			}
			{	// pelvis
				Fixtures[(int)EBipedFixtureIndex.Pelvis].Shape = new PolygonShape(
					_scale * new Vec2(.105f, .051f),
					_scale * new Vec2(.277f, .053f),
					_scale * new Vec2(.320f, .233f),
					_scale * new Vec2(.112f, .233f),
					_scale * new Vec2(.067f, .152f));
			}
			{	// stomach
				Fixtures[(int)EBipedFixtureIndex.Stomach].Shape = new PolygonShape(
					_scale * new Vec2(.088f, .043f),
					_scale * new Vec2(.284f, .043f),
					_scale * new Vec2(.295f, .231f),
					_scale * new Vec2(.100f, .231f));
			}
			{	// chest
				Fixtures[(int)EBipedFixtureIndex.Chest].Shape = new PolygonShape(
					_scale * new Vec2(.091f, .042f),
					_scale * new Vec2(.283f, .042f),
					_scale * new Vec2(.177f, .289f),
					_scale * new Vec2(.065f, .289f));
			}
			{	// head
				Fixtures[(int)EBipedFixtureIndex.Head].Shape = new CircleShape(_scale * .115f);
			}
			{	// neck
				Fixtures[(int)EBipedFixtureIndex.Neck].Shape = new PolygonShape(
					_scale * new Vec2(.038f, .054f),
					_scale * new Vec2(.149f, .054f),
					_scale * new Vec2(.154f, .102f),
					_scale * new Vec2(.054f, .113f));
			}
			{	// upper arms
				Fixtures[(int)EBipedFixtureIndex.LUpperArm].Shape =
					Fixtures[(int)EBipedFixtureIndex.RUpperArm].Shape =
					new PolygonShape(
						_scale * new Vec2(.092f, .059f),
						_scale * new Vec2(.159f, .059f),
						_scale * new Vec2(.169f, .335f),
						_scale * new Vec2(.078f, .335f),
						_scale * new Vec2(.064f, .248f));
			}
			{	// forearms
				Fixtures[(int)EBipedFixtureIndex.LForearm].Shape =
					Fixtures[(int)EBipedFixtureIndex.RForearm].Shape =
					new PolygonShape(
						_scale * new Vec2(.082f, .054f),
						_scale * new Vec2(.138f, .054f),
						_scale * new Vec2(.149f, .296f),
						_scale * new Vec2(.088f, .296f));
			}
			{	// hands
				Fixtures[(int)EBipedFixtureIndex.LHand].Shape =
					Fixtures[(int)EBipedFixtureIndex.RHand].Shape =
					new PolygonShape(
						_scale * new Vec2(.066f, .031f),
						_scale * new Vec2(.123f, .020f),
						_scale * new Vec2(.160f, .127f),
						_scale * new Vec2(.127f, .178f),
						_scale * new Vec2(.074f, .178f));
			}
		}

		void DefaultPositions()
		{
			Bodies[(int)EBipedFixtureIndex.LFoot].Position = Bodies[(int)EBipedFixtureIndex.RFoot].Position = _scale * new Vec2(-.122f, -.901f);
			Bodies[(int)EBipedFixtureIndex.LCalf].Position = Bodies[(int)EBipedFixtureIndex.RCalf].Position = _scale * new Vec2(-.177f, -.771f);
			Bodies[(int)EBipedFixtureIndex.LThigh].Position = Bodies[(int)EBipedFixtureIndex.RThigh].Position = _scale * new Vec2(-.217f, -.391f);
			Bodies[(int)EBipedFixtureIndex.LUpperArm].Position = Bodies[(int)EBipedFixtureIndex.RUpperArm].Position = _scale * new Vec2(-.127f, .228f);
			Bodies[(int)EBipedFixtureIndex.LForearm].Position = Bodies[(int)EBipedFixtureIndex.RForearm].Position = _scale * new Vec2(-.117f, -.011f);
			Bodies[(int)EBipedFixtureIndex.LHand].Position = Bodies[(int)EBipedFixtureIndex.RHand].Position = _scale * new Vec2(-.112f, -.136f);
			Bodies[(int)EBipedFixtureIndex.Pelvis].Position = _scale * new Vec2(-.177f, -.101f);
			Bodies[(int)EBipedFixtureIndex.Stomach].Position = _scale * new Vec2(-.142f, .088f);
			Bodies[(int)EBipedFixtureIndex.Chest].Position = _scale * new Vec2(-.132f, .282f);
			Bodies[(int)EBipedFixtureIndex.Neck].Position = _scale * new Vec2(-.102f, .518f);
			Bodies[(int)EBipedFixtureIndex.Head].Position = _scale * new Vec2(.022f, .738f);
		}
		...
		void DefaultJoints()
		{
			...
			{	// ankles
				Vec2 anchor = _scale * new Vec2(-.045f, -.75f);
				...
				Joints[(int)EBipedJointIndex.LAnkle].LowerAngle = Joints[(int)EBipedJointIndex.RAnkle].LowerAngle = -0.523598776f;
				Joints[(int)EBipedJointIndex.LAnkle].UpperAngle = Joints[(int)EBipedJointIndex.RAnkle].UpperAngle = 0.523598776f;
			}
			...
			{	// knees
				Vec2 anchor = _scale * new Vec2(-.030f, -.355f);
				...
				Joints[(int)EBipedJointIndex.LKnee].LowerAngle = Joints[(int)EBipedJointIndex.RKnee].LowerAngle = 0;
				Joints[(int)EBipedJointIndex.LKnee].UpperAngle = Joints[(int)EBipedJointIndex.RKnee].UpperAngle = 2.61799388f;
			}
			...
			{	// hips
				Vec2 anchor = _scale * new Vec2(.005f, -.045f);
				...
				Joints[(int)EBipedJointIndex.LHip].LowerAngle = Joints[(int)EBipedJointIndex.RHip].LowerAngle = -2.26892803f;
			...
			{	// lower abs
				Vec2 anchor = _scale * new Vec2(.035f, .135f);
				...
				Joints[(int)EBipedJointIndex.LowerAbs].LowerAngle = -0.523598776f;
				Joints[(int)EBipedJointIndex.LowerAbs].UpperAngle = 0.523598776f;
			}

			//b.UpperAbsDef.body1		= Stomach;
			//b.UpperAbsDef.body2		= Chest;
			{	// upper abs
				Vec2 anchor = _scale * new Vec2(.045f, .320f);
				...
				Joints[(int)EBipedJointIndex.UpperAbs].LowerAngle = -0.523598776f;
				Joints[(int)EBipedJointIndex.UpperAbs].UpperAngle = 0.174532925f;
			}

			//b.LowerNeckDef.body1	= Chest;
			//b.LowerNeckDef.body2	= Neck;
			{	// lower neck
				Vec2 anchor = _scale * new Vec2(-.015f, .575f);
				...
				Joints[(int)EBipedJointIndex.LowerNeck].LowerAngle = -0.174532925f;
				Joints[(int)EBipedJointIndex.LowerNeck].UpperAngle = 0.174532925f;
			}

			//b.UpperNeckDef.body1	= Chest;
			//b.UpperNeckDef.body2	= Head;
			{	// upper neck
				Vec2 anchor = _scale * new Vec2(-.005f, .630f);
				...
				Joints[(int)EBipedJointIndex.UpperNeck].LowerAngle = -0.610865238f;
				Joints[(int)EBipedJointIndex.UpperNeck].UpperAngle = 0.785398163f;
			}
			...
			{	// shoulders
				Vec2 anchor = _scale * new Vec2(-.015f, .545f);
				...
				Joints[(int)EBipedJointIndex.LShoulder].LowerAngle = Joints[(int)EBipedJointIndex.RShoulder].LowerAngle = -1.04719755f;
				Joints[(int)EBipedJointIndex.LShoulder].UpperAngle = Joints[(int)EBipedJointIndex.RShoulder].UpperAngle = 3.14159265f;
			}
			...
			{	// elbows
				Vec2 anchor = _scale * new Vec2(-.005f, .290f);
				...
				Joints[(int)EBipedJointIndex.LElbow].LowerAngle = Joints[(int)EBipedJointIndex.RElbow].LowerAngle = -2.7925268f;
			...
			{	// wrists
				Vec2 anchor = _scale * new Vec2(-.010f, .045f);
				...
				Joints[(int)EBipedJointIndex.LWrist].LowerAngle = Joints[(int)EBipedJointIndex.RWrist].LowerAngle = -0.174532925f;
				Joints[(int)EBipedJointIndex.LWrist].UpperAngle = Joints[(int)EBipedJointIndex.RWrist].UpperAngle = 0.174532925f;
			}
		}
	};
}
